...
<img src="assets/brand/logo-icon.png" alt="Trusted Peptide" class="brand-logo" width="64" height="64" />
      ...
      <div class="header-actions">
        <a href="/ar/cosmetics" class="lang-switch" title="التبديل إلى العربية">عربي</a>
    ...
    <nav class="mobile-nav">
      ...
      <a href="gallery">Gallery</a>
      <a href="contact">Contact</a>
      <a href="/ar/cosmetics" class="lang-switch">عربي</a>
    </nav>

  <main class="section container" style="padding-top:56px;">
    <div class="section-head reveal">
      <div>
        <span class="eyebrow">Cosmetics Collection</span>
        <h1 style="margin-bottom:0;">Beauty, Backed by Science.</h1>
      </div>
    </div>
    ...
    <div class="catalog-toolbar">
      <div class="catalog-search-row">
        ...
        <input type="text" id="search-input" class="search-input" placeholder="Search cosmetics…" />
      </div>
    </div>
