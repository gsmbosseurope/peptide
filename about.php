...
<head>
  ...
  <title>About â trusted-peptide.com</title>
  ...
  <meta property="og:title" content="About â trusted-peptide.com" />
  ...
  <meta name="twitter:title" content="About â trusted-peptide.com" />
  ...
  <main>
    <section class="hero" style="max-width:var(--max-width); margin:0 auto; padding-left:24px; padding-right:24px;">
      <div class="container" style="display:contents;">
        <div class="hero-copy">
          ...
          <span class="eyebrow">EU Sourced Â· HPLC Verified</span>
          <h1>Research peptides,<br />measured to the <span class="hl">microgram.</span></h1>
          <p class="hero-lede">120+ peptides across recovery, metabolic, and dermal research categories. Every batch certified, every price transparent â pick a size, pick a quantity, watch the price update instantly.</p>
        ...
        <div class="hero-visual">
          ...
          <div class="vial-card"><b>BPC-157 Â· 5mg</b>Lot verified Â· 99.9% purity</div>
        </div>
      </div>
    </section>
    ...
    <section class="section container">
      <div class="split-section reveal">
        <div>
          ...
          <p>We publish exact composition and purity for every peptide â no vague "proprietary blend" language. What's on the label is what's in the vial.</p>
        </div>
    ...
    <section class="section container">
      <div class="section-head reveal">
        ...
        <a href="products" class="btn btn-ghost">View all products â</a>
      </div>
    ...
    <section class="section container reveal">
      <div class="split-section">
        <div>
          ...
          <p>Every product page shows live wholesale pricing â order 5 units and unlock your first discount tier, order 10 and unlock the next. No codes, no waiting: the price updates as you type.</p>
