...
<head>
  ...
  <title>Page Not Found — trusted-peptide.com</title>
...
<img src="assets/brand/logo-icon.png" alt="Trusted Peptide" class="brand-logo" width="64" height="64" />
      ...
      <div class="header-actions">
        <a href="/ar/404" class="lang-switch" title="التبديل إلى العربية">عربي</a>
    ...
    <nav class="mobile-nav">
      ...
      <a href="contact">Contact</a>
      <a href="/ar/404" class="lang-switch">عربي</a>
    </nav>
  ...
  <main class="section container" style="text-align:center;">
    ...
    <div class="hero-cta-row" style="justify-content:center; margin-top:24px;">
      ...
      <a href="products" class="btn btn-secondary">Browse Catalog</a>
    </div>
  </main>
