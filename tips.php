...
<head>
  ...
  <link rel="canonical" href="https://trusted-peptide.com/tips" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Trusted-Peptide" />
  <meta property="og:title" content="Tips & Guide — trusted-peptide.com" />
  <meta property="og:description" content="Storage, handling, and reconstitution guides for research peptides." />
  <meta property="og:url" content="https://trusted-peptide.com/tips" />
  <meta property="og:image" content="https://trusted-peptide.com/assets/brand/hero-vials.jpg" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Tips & Guide — trusted-peptide.com" />
  <meta name="twitter:description" content="Storage, handling, and reconstitution guides for research peptides." />
...
<img src="assets/brand/logo-icon.png" alt="Trusted Peptide" class="brand-logo" />
  ...
  <main class="section container" style="padding-top:56px;">
    ...
    <div class="guide-grid" id="guides-grid">
      <?php foreach ($allGuides as $g): if (empty($g['id'])) continue; ?>
      <!-- Server-rendered fallback card: replaced by guides.js on load. -->
      <a class="guide-card" href="tip?id=<?php echo rawurlencode($g['id']); ?>">
        <div class="guide-card-body">
          <span class="guide-card-title"><?php echo htmlspecialchars($g['title']); ?></span>
          <p class="guide-card-summary"><?php echo htmlspecialchars($g['summary']); ?></p>
        </div>
      </a>
      <?php endforeach; ?>
    </div>
