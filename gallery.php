  ...
  <main class="section container" style="padding-top:56px;">
    <div class="section-head reveal">
      <div>
        ...
        <p style="max-width:52ch; margin-top:12px;">A look at our lab, packaging, and products.</p>
      </div>
    </div>
  ...
  <footer class="site-footer">
    <div class="container">
      <div class="footer-grid">
        ...
        <div>
          <h4>Company</h4>
          <ul><li><a href="about">About</a></li><li><a href="blog">Blog</a></li><li><a href="tips">Tips &amp; Guide</a></li><li><a href="peptide-guide">Peptide Guide</a></li><li><a href="gallery">Gallery</a></li><li><a href="contact">Contact</a></li></ul>
        </div>
        <div>
          <h4>Contact</h4>
