...
},
{
    ...
    "purity": "99.0%",
    "showPurity": false,
    "shortDescription": "نظير معدّل ومستقر للطرف C من هرمون النمو يحفز إطلاق الدهون من الخلايا الشحمية دون رفع سكر الدم، مع فائدة إضافية في إصلاح الغضاريف والمفاصل.",
    "composition": [
        "نظير معدّل لهرمون النمو (الأحماض الأمينية 177-191)",
        "يحفز إطلاق الدهون من الخلايا الشحمية",
        "لا يرفع مستوى الجلوكوز في الدم",
        "يساعد في إصلاح الغضاريف والمفاصل كفائدة ثانوية"
    ],
    "uses": [
        "فقدان الدهون دون اضطراب الأنسولين",
        "دعم صحة المفاصل والغضاريف مع حرق الدهون",
        "إعادة تشكيل الجسم"
    ],
    "images": [
...
},
{
    ...
    "purity": "99.0%",
    "showPurity": false,
    "shortDescription": "هرمون الصنوبرية الذي يزامن دورات النوم والاستيقاظ اليومية بينما يوفر حماية عصبية مضادة للأكسدة المباشرة.",
    "composition": [
        "N-أسيتيل-5-ميثوكسي تريبتامين (ميلاتونين)",
        "يزامن الإيقاع اليومي عبر مستقبلات MT1/MT2",
        "مضاد أكسدة مباشر لاصطياد الجذور الحرة",
        "واقٍ للأعصاب ضد الإجهاد التأكسدي"
    ],
    "uses": [
        "تنظيم دورة النوم والأرق",
        "التكيف مع الرحلات الجوية الطويلة وعمل الورديات",
        "الحماية العصبية المضادة للأكسدة",
        "مكافحة الشيخوخة ودعم الإيقاع اليومي"
    ],
    "images": [
