...
<head>
  ...
  <title>الصفحة غير موجودة — trusted-peptide.com</title>
...
<img src="../assets/brand/logo-icon.png" alt="Trusted Peptide" class="brand-logo" />
      ...
      <div class="header-actions">
        <a href="/404" class="lang-switch" title="Switch to English">EN</a>
    ...
    <nav class="mobile-nav">
      ...
      <a href="gallery">معرض الصور</a>
      <a href="contact">تواصل معنا</a>
      <a href="/404" class="lang-switch">English</a>
    </nav>
  ...
  <main class="section container" style="text-align:center;">
    ...
    <div class="hero-cta-row" style="justify-content:center; margin-top:24px;">
      <a href="/ar/" class="btn btn-primary">العودة للرئيسية</a>
      <a href="products" class="btn btn-secondary">تصفح الكتالوج</a>
    </div>
  </main>
  ...
  <footer class="site-footer">
    <div class="container">
      <div class="footer-seal-col footer-seal-solo"><img class="badge-eu badge-eu--light" src="../assets/brand/purity-badge-light.webp" alt="ببتيد نقي 99%" width="96" height="96" loading="lazy" /><img class="badge-eu badge-eu--dark" src="../assets/brand/purity-badge-dark.webp" alt="ببتيد نقي 99%" width="96" height="96" loading="lazy" /></div>
