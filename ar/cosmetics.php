...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="https://trusted-peptide.com/ar/cosmetics" />
...
<img src="../assets/brand/logo-icon.png" alt="Trusted Peptide" class="brand-logo" />
      ...
      <div class="header-actions">
        <a href="/cosmetics" class="lang-switch" title="Switch to English">EN</a>
    ...
    <nav class="mobile-nav">
      ...
      <a href="gallery">معرض الصور</a>
      <a href="contact">تواصل معنا</a>
      <a href="/cosmetics" class="lang-switch">English</a>
    </nav>

  <main class="section container" style="padding-top:56px;">
    <div class="section-head reveal">
      <div>
        <span class="eyebrow">مجموعة التجميل</span>
        <h1 style="margin-bottom:0;">جمال مدعوم بالعلم.</h1>
      </div>
    </div>
    ...
    <div class="catalog-toolbar">
      <div class="catalog-search-row">
        ...
        <input type="text" id="search-input" class="search-input" placeholder="ابحث في مستحضرات التجميل…" />
      </div>
    </div>

    <div class="product-grid" id="product-grid" data-section="cosmetic"></div>
  </main>
