...
// PEPTIDE_TOPICS/load_peptide_topics() holds both English topics and their
// separate Arabic counterparts, distinguished only by an "-ar" id suffix —
// filter to just those or English topics leak onto this Arabic page.
$allTopics = array_values(array_filter(load_peptide_topics(), function ($t) {
    return !empty($t['id']) && substr($t['id'], -3) === '-ar';
}));
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="alternate" hreflang="ar" href="https://trusted-peptide.com/ar/peptide-guide" />
...
<img src="../assets/brand/logo-icon.png" alt="Trusted Peptide" class="brand-logo" />
      ...
      <div class="header-actions">
        <a href="/peptide-guide" class="lang-switch" title="Switch to English">EN</a>
    ...
    <nav class="mobile-nav">
      ...
      <a href="gallery">معرض الصور</a>
      <a href="contact">تواصل معنا</a>
      <a href="/peptide-guide" class="lang-switch">English</a>
    </nav>

  <main class="section container" style="padding-top:56px;">
    <div class="section-head reveal">
      <div>
        <span class="eyebrow">دليل الببتيد</span>
        <h1 style="margin-bottom:0;">مواضيع دليل الببتيد</h1>
        <p style="max-width:52ch; margin-top:12px;">أدلة مواضيع متعمقة تغطي فئات الببتيد وآلياته وتطبيقاته البحثية.</p>
        <p style="max-width:52ch; margin-top:8px; color:var(--text-secondary); font-size:0.85rem;">للاستخدام البحثي والمخبري فقط. محتوى تعليمي، وليس نصيحة طبية.</p>
      </div>
    </div>

    <?php if (empty($allTopics)): ?>
    <div class="empty-state">
      <h3>لا توجد مواضيع بعد</h3>
      <p>عد قريباً.</p>
    </div>
    <?php else: ?>
    <div class="guide-grid" id="peptide-topics-grid">
      <?php foreach ($allTopics as $t): if (empty($t['id'])) continue; ?>
      <!-- Server-rendered fallback card: replaced by peptide-guide-ar.js on load. -->
      ...
      <div class="footer-grid">
        ...
        <div>
          ...
          <ul>
            ...
            <li><a href="peptide-guide">دليل الببتيد</a></li>
          </ul>
        </div>
        <div class="footer-seal-col">
          <img class="badge-eu badge-eu--light" src="../assets/brand/purity-badge-light.webp" alt="ببتيد نقي 99%" width="96" height="96" loading="lazy" /><img class="badge-eu badge-eu--dark" src="../assets/brand/purity-badge-dark.webp" alt="ببتيد نقي 99%" width="96" height="96" loading="lazy" />
        </div>
      </div>
