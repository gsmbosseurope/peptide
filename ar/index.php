...
<img src="../assets/brand/logo-icon.png" alt="Trusted Peptide" class="brand-logo" />
  ...
  <main class="section container" style="padding-top:16px;">
    <div style="display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap; margin-bottom:24px;">
      <span class="eyebrow" style="margin:0;">الأكثر طلباً</span>
      <a href="products" class="btn btn-ghost view-all-products-link">عرض الكل<span class="view-all-products-word"> المنتجات</span> ←</a>
    </div>
  ...
  <footer class="site-footer">
    <div class="container">
      <div class="footer-grid">
        ...
        <div>
          <h4>المتجر</h4>
          <ul><li><a href="/ar/">كل المنتجات</a></li><li><a href="../cart">السلة</a></li><li><a href="../checkout">إتمام الطلب</a></li><li><a href="../contact">الدعم</a></li></ul>
        </div>
        <div>
          <h4>الشركة</h4>
